...
{{--                        <div class="card-body">--}}
{{--                            <img class="card-img-top img-fluid" src="{{ asset('/app-assets/images/carousel/05.jpg') }}" alt="Card image cap">--}}
{{--                            <div class="card-block">--}}
...
{{--                                        <img src="{{ asset('/app-assets/images/carousel/02.jpg') }}" alt="First slide">--}}
{{--                                    </div>--}}
{{--                                    <div class="carousel-item active">--}}
{{--                                        <img src="{{ asset('/app-assets/images/carousel/03.jpg') }}" alt="Second slide">--}}
{{--                                    </div>--}}
{{--                                    <div class="carousel-item">--}}
{{--                                        <img src="{{ asset('/app-assets/images/carousel/01.jpg') }}" alt="Third slide">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
