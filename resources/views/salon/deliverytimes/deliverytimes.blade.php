    ...
    <div class="app-content content container-fluid">
        <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"> {{trans('admin.deliverytimes')}}
                </li>
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="{{url('deliverytimes/create')}} "
                               class="btn btn-info btn-bg">{{trans('admin.add_deliverytimes')}} </a>
                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        @foreach($times as $cat)
                                            <tr>
                                                ...
                                                <td class="text-lg-center">{{$cat->delivery_time}}</td>
                                                <td class="text-lg-center"><a class='btn btn-raised btn-success btn-sml'
                                                                              href=" {{url('deliverytimes/'.$cat->id.'/edit')}}"><i
                                                            class="icon-edit"></i></a>

                                                    <form method="get" id='delete-form-{{ $cat->id }}'
                                                          action="{{url('deliverytimes/'.$cat->id.'/delete')}}"
                                                          style='display: none;'>
                                                    {{csrf_field()}}
                                                    <!-- {{method_field('delete')}} -->
                                                    </form>
