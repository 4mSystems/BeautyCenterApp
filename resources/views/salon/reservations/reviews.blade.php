                        ...
                        <div class="card-body">
                            ...
                            <div class="card-block">
                                ...
                                <blockquote class="blockquote border-left-primary border-left-3">
                                    <p class="mb-0">Sometimes when you innovate, you make mistakes. It is best to admit
                                        them quickly, and get on with improving your other innovations.</p>
                                </blockquote>
                                <hr>
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="form-group">
                                        {{ Form::text('name',old('name'),["class"=>"form-control round" ,"required",'placeholder'=>trans('admin.write_review') ]) }}
                                    </div>
